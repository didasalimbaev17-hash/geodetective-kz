...
export const almatySmogScenario: Scenario = {
  ...
  explanationTask: {
    prompt: {
      kk: "Сіздің шешіміңіз неліктен Алматы ауасын тазартады? Қазаншұңқыр факторын ескердіңіз бе? 150-400 сөз.",
      ru: "Почему ваше решение очистит воздух? Учли ли вы фактор котловины? 150-400 слов.",
    },
    minWords: 150,
    maxWords: 400,
    language: "kk",
