...
export const aralScenario: Scenario = {
  ...
  evidence: [
    ...
    },
    {
      ...
      content: {
        source: {
          kk: "Қалымбет Ержанов, 68 жас, бұрынғы балықшы, 2019 жылғы сұхбат",
          ru: "Калымбет Ержанов, 68 лет, бывший рыбак, интервью 2019",
        },
        body: {
          kk: "«Мен 1970 жылы Мойнақта балықшы болып жұмыс істей бастадым. Сол кезде порт жұмыс істеп тұрды, жылына 30 мың тонна балық ауланатын. 1985 жылға қарай теңіз 20 шақырымға шегініп кетті. 1990 жылы соңғы зауыт жабылды. Менің үш ұлым кетіп қалды — Ресейге, Қазақстанға. Мен қалдым — кеме қорымы — ескерткіш қана».",
          ru: "«Я начал работать рыбаком в Муйнаке в 1970 году. Тогда порт работал, добывали 30 тысяч тонн рыбы в год. К 1985 море отступило на 20 километров. В 1990 закрылся последний завод. Все три моих сына уехали — в Россию, в Казахстан. Я остался — кладбище кораблей это памятник».",
        },
      },
    },
    {
      ...
      content: {
        ...
        caption: {
          kk: "ҚР Денсаулық сақтау министрлігі, 2022 жылғы есеп. Тұзды-улы шаң — басты себеп.",
          ru: "Отчёт Минздрава РК, 2022. Солёно-токсичная пыль — основная причина.",
        },
      },
    },
    {
      ...
      content: {
        ...
        caption: {
          kk: "Норма — 3 г/кг-ға дейін. Бұрынғы жағалау 16 есе асырады. Жыл сайын тұзды шаң 75 млн тонна Орт. Азияға таралады.",
          ru: "Норма — до 3 г/кг. Бывшее побережье превышает в 16 раз. Ежегодно 75 млн тонн солёной пыли разносятся по Центральной Азии.",
        },
      },
    },
  ],
