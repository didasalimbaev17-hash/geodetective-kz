    ...
    <div className="container max-w-3xl py-16">
      ...
      <div className="grid gap-4 mb-12">
        <Feature
          ...
          text={
            isRu
              ? "Кейсы основаны на реальных экологических данных: NASA, Wikipedia, отчёты Всемирного банка."
              : "Кейстер шынайы экологиялық деректерге негізделген: NASA, Wikipedia, Дүниежүзілік Банк есептері."
          }
        />
        <Feature
          icon={Brain}
          title={isRu ? "AI-оценка" : "ИИ бағалауы"}
          text={
            isRu
        ...
        <Feature
          ...
          text={
            isRu
              ? "Учительский кабинет: классы, прогресс, ручная корректировка AI-оценок. Геймификация для учеников: XP, бейджи, уровни."
              : "Мұғалім кабинеті: сыныптар, прогресс, ИИ бағаларын қолмен түзету. Оқушыларға геймификация: XP, белгілер, деңгейлер."
          }
        />
      </div>
